...
const STAGES = [
  ...
  { id: 2, title: 'پرواز سیمرغ',      env: 'آسمان البرز',  boss: 'طوفان بزرگ البرز',     playable: false,
    desc: 'سوار بر سیمرغ، جاخالی از صاعقه و عبور از طوفان و تنگه‌های سنگی.' },
  { id: 3, title: 'نجات بچه عقاب',    env: 'کوه البرز',   boss: 'شیر کوهستان',          playable: false,
    desc: 'نجات بچه عقاب از چنگال شیر؛ پاداش: همراهی عقاب ایرانی.' },
  { id: 4, title: 'بازگشت به ایران',  env: 'دربار شاه',   boss: 'پهلوان نامدار دربار',  playable: false,
    desc: 'آموزش کشتی، شمشیرزنی و تیراندازی؛ دریافت لقب پهلوان زابل.' },
  { id: 5, title: 'کفتار دشت زابل',   env: 'زابلستان',    boss: 'کفتار غول‌پیکر زابل',  playable: false,
    desc: 'تعقیب ردپا و شکار هیولایی که روستاها را نابود می‌کند.' },
  { id: 6, title: 'عشق رودابه',       env: 'شهر کابل',    boss: 'فرمانده محافظان مهراب',playable: false,
    desc: 'نفوذ مخفیانه، بالا رفتن از دیوار قصر و دیدار با رودابه.' },
  { id: 7, title: 'فرمانروای زابل',   env: 'نقشه جهان',   boss: 'دیو کوهستان / سردار شورشی', playable: false,
    desc: 'دفاع از مرزها، سرکوب شورش‌ها و نبرد با دیوان.' },
  { id: 8, title: 'تولد رستم',        env: 'پر سیمرغ',    boss: 'غول صحرا',             playable: false,
